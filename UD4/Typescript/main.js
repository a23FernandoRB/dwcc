var paises = ["Belgica", "Austria", "Bharat", "Paraguay", "China", "Francia"];
...
function printnumero() {
    document.getElementById("numeroelementos").innerText = numeroelementos().toString();
}
...
function ensenarelementos() {
    ...
    for (var i = 0; i <= numeroelementos() - 1; i++) {
...
function ensenarinverso() {
    ...
    for (var i = (numeroelementos() - 1); i >= 0; i--) {
...
function anadirprincipio() {
    ...
    var elemento = document.getElementById("elementoprincipio").value;
    paises.unshift(elemento);
}
//añadir elemento al final
function anadirfinal() {
    this.event.preventDefault();
    var elemento = document.getElementById("elementofinal").value;
...
function eliminarprincipio() {
    if (numeroelementos() > 0) {
        ...
        alert("No se pudo eliminar. La lista no contiene elementos.");
}
...
function ensenarPosicion() {
    this.event.preventDefault();
    var posicion = Number(document.getElementById("pos").value);
...
function ensenarEntreElementos() {
    ...
    var posicion1 = Number(document.getElementById("posEl1").value);
    var posicion2 = Number(document.getElementById("posEl2").value);
